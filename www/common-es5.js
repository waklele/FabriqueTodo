...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppTodoTodoServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var KEY_DATA_TODO = "dataTodo";

    var TodoService = /*#__PURE__*/function () {
      function TodoService(storage, toastController) {
      ...
      _createClass(TodoService, [{
        key: "showMessage",
        value: function showMessage(textPesan) {
        ...
        key: "simpanData",
        value: function simpanData(tempData) {
          this.listDataTodo.push(tempData);
          this.storage.set(KEY_DATA_TODO, JSON.stringify(this.listDataTodo));
        }
      }, {
        key: "ambilData",
        value: function ambilData() {
          ...
          this.storage.get(KEY_DATA_TODO).then(function (data) {
            if (data != null) {
              _this.listDataTodo = JSON.parse(data);
              console.log(_this.listDataTodo);
            } else {
              _this.listDataTodo = [];
              console.log('empty');
            }
