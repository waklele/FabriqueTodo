...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["todo-todo-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTodoTodoPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTodoTodoRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTodoTodoPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTodoTodoPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var TodoPage = /*#__PURE__*/function () {
      function TodoPage(router, todo) {
        ...
        this.listDataTodo = [];
        setTimeout(function () {
          _this.listDataTodo = _this.todo.listDataTodo;
        }, 1000);
      }
      ...
      _createClass(TodoPage, [{
        ...
        key: "goTambahTodo",
        value: function goTambahTodo() {
          this.router.navigate(['/todo/addtodo']);
        }
      }, {
        key: "hapusDataTodo",
        value: function hapusDataTodo(item) {
          this.todo.hapusData(item);
          this.todo.showMessage("Data berhasil dihapus");
        }
      }, {
        key: "hapusSemuaDataTodo",
        value: function hapusSemuaDataTodo() {
    ...
    TodoPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/todo/todo.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./todo.page.scss */
      "./src/app/todo/todo.page.scss"))["default"]]
    })], TodoPage);
    /***/
  }
}]);
